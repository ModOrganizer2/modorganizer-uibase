...
public:
   ...
   * profile.
   *
   * @param iniFile INI file to retrieve a path for. This can either be the name of a
   * file or a path to the absolute file outside of the profile.
   *
   ...
   * current game (as returned by IPluginGame::iniFiles), the path to the global file
   * will be returned (if iniFile is absolute, iniFile is returned, otherwise the path
   * is assumed relative to the game documents directory).
   */
